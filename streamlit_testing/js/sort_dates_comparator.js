/**
 * Sorts two dates.
 * NB: A separate function is using for comparing dates when filtering as AG Grid expects different return values for filtering versus sorting. For filtering, AG Grid expects:
